...
- `reference/playbooks/signals/market-insights.md` — For validating new signals
- `reference/playbooks/nansen/accumulation-check.md` — For re-analyzing watchlist items
